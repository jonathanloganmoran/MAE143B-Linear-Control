...
ylim([-2 3]);
legend('$\tau(t) = \tilde{\tau}$','$\tau(t) = \tilde{\tau}cos(\omega t), \omega = \frac{a}{b}\cdot\frac{\pi}{180} \simeq 0.15$', '$\tau(t) = \tilde{\tau}cos(\omega t), \omega = 0.4$', '$\tau(t) = \tilde{\tau}cos(\omega t), \omega = 2.0$', 'location', 'northeast', 'interpreter', 'latex');
title("$\textrm{Elevator's linear velocity for torque input reference (Problem 3.69)}$", 'Interpreter', 'latex');
...
title("$\textrm{Elevator's linear position for torque input reference (Problem 3.69)}$", 'interpreter', 'latex');
subtitle('$m_2 = 1000 kg$', 'interpreter', 'latex');
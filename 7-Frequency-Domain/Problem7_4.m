...
% closed-loop system is stable under negative unit feedback.
...
% Therefore, the system is stable for all values of gain K > 0. 
...
% values of gain K > 0. Furthermore, the closed-loop system is stable under 
% negative unit feedback as N = P = 0.
...
% under negative unit feedback is unstable.
% Calculating the gain margin of the closed-loop system
gm = allmargin(sys).GainMargin
% The gain margin has a value of 0.001, meaning that the closed-loop system
% under negative unit feedback is stable for values of gain K > 0.001. 
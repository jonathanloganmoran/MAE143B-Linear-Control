...
title('$\textrm{Magnitude of response of transfer function in Problem 4.27}$', 'interpreter', 'latex');
...
% Plotting the response of the second-order system in P4.27
figure;
plot(t, x_1_bar*heaviside(t));
hold on;
plot(t, x_t1)
grid on;
title('Closed-loop response of system in Problem 4.27 for $m_2 = 800 kg$', 'interpreter', 'latex');

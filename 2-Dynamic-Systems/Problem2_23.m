...
e_ss = v_bar - (r/(b + K*r))*(K*v_1_bar + w);   % m/s
...
subtitle('$m_2 = 1000 kg, \tau = K(\bar{v_1} -v_1(t)) Nm$', 'interpreter', 'latex');
...
ylabel('$v(t) m/s$', 'interpreter', 'latex');
legend('$v_1(0) = 0 m/s$', '$v_1(0) = 1 m/s$', '$v_1(0) = -1 m/s$',  'interpreter', 'latex', location='southeast');
subtitle('$m_2 = 1000 kg, \tilde{\tau} = 480 Nm$', 'interpreter', 'latex');

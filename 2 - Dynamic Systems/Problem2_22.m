...
title('Linear velocity of elevator model (Problem 2.22)', 'interpreter', 'latex');
xlabel('$t(s)$', 'interpreter', 'latex');
ylabel('$v(t) m/s$', 'interpreter', 'latex');
legend('$v_1(0) = 0 m/s$', '$v_1(0) = 1 m/s$', '$v_1(0) = -1 m/s$',  'interpreter', 'latex', location='southeast');
subtitle('$m_2 = 800 kg, \bar{\tau} = -1520 Nm$', 'interpreter', 'latex');
...
ylabel('$v(t) m/s$', 'interpreter', 'latex');
legend('$v_1(0) = 0 m/s$', '$v_1(0) = 1 m/s$', '$v_1(0) = -1 m/s$',  'interpreter', 'latex', location='southeast');
subtitle('$m_2 = 800 kg, \bar{\tau} = 480 Nm$', 'interpreter', 'latex');